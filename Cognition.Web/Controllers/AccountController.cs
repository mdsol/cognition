...
namespace Cognition.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IAppSettingProvider appSettingProvider) 
        {
            this.appSettingProvider = appSettingProvider;
            IdentityStore = new IdentityStoreManager(new CognitionUserContext(new CognitionIdentityDbContext()));
        ...
        {
            if (!RegistrationIsAllowed()) return new HttpUnauthorizedResult();
            return View();
        }

        private bool RegistrationIsAllowed()
        {
            return appSettingProvider.GetBool("AllowRegistration");
        }
